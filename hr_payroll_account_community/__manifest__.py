...
#############################################################################
{
    ...
    'depends': ['hr_payroll_community', 'account','mail','report_xlsx'],
    'data': [
            'data/data.xml',
            ...
            'report/hr_payslip_batches_report.xml',
            'report/report_hr_payslip_batches_template.xml',
            'report/hr_payslip_batches_xlsx_report.xml',
    ],
