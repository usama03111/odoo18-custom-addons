...
class PayrollApprover(models.Model):
    _name = "payroll.approver"
    _description = "Payroll Approver"
    _rec_name = 'name'
    ...
    approver_ids = fields.One2many('payroll.category.approver', 'approver_id', string="Approvers")
    ...
    reset_by_employee_id = fields.Many2one(
        'hr.employee',
        string="Reset By",
        help="Employee who reset this payslip to draft"
    )
